...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (file_exists($target_file)) {
        ...
        echo "<script>window.location.href='pollos.php';</script>";
        exit();
    }
    ...
    if (move_uploaded_file($_FILES['imagen']['tmp_name'], $target_file)) {
        ...
        $query = "INSERT INTO Pollos (nombre, precio, descripcion, imagen) VALUES ('$nombre', '$precio', '$descripcion', '$imagen')";
        
        if ($conn->query($query) === TRUE) {
            echo "Nuevo pollo agregado correctamente.<br>";
        } else {
